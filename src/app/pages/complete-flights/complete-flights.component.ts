...
@Component({
  selector: 'app-complete-flights',
  templateUrl: './complete-flights.component.html',
  styleUrls: ['./complete-flights.component.scss']
})
export class CompleteFlightsComponent {
